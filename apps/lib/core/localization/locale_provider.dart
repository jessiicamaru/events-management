...
class AppTranslations {
  static const Map<String, Map<AppLocale, String>> _keys = {
    ...
    'appearance_desc': {AppLocale.en: 'Theme Mode & Brand Colors', AppLocale.vi: 'Chế độ nền & Màu sắc thương hiệu'},
    'theme_mode_title': {AppLocale.en: 'Theme Mode', AppLocale.vi: 'Chế độ nền'},
    ...
    'primary_color_title': {AppLocale.en: 'Primary Color', AppLocale.vi: 'Màu sắc chính'},
    'profile_title': {AppLocale.en: 'Profile', AppLocale.vi: 'Hồ sơ cá nhân'},
    'profile_desc': {AppLocale.en: 'Manage user details and password', AppLocale.vi: 'Quản lý thông tin cá nhân và mật khẩu'},
    'profile_name': {AppLocale.en: 'Display Name', AppLocale.vi: 'Tên hiển thị'},
    ...
    'profile_phone': {AppLocale.en: 'Phone Number', AppLocale.vi: 'Số điện thoại'},
    ...
    'profile_avatar': {AppLocale.en: 'Select Avatar', AppLocale.vi: 'Chọn ảnh đại diện'},
    'profile_update_success': {AppLocale.en: 'Profile updated successfully', AppLocale.vi: 'Cập nhật hồ sơ thành công'},
    'change_password_title': {AppLocale.en: 'Change Password', AppLocale.vi: 'Đổi mật khẩu'},
    'change_password_desc': {AppLocale.en: 'Enter your current and new password.', AppLocale.vi: 'Nhập mật khẩu hiện tại và mật khẩu mới.'},
    'current_password': {AppLocale.en: 'Current Password', AppLocale.vi: 'Mật khẩu hiện tại'},
    'new_password': {AppLocale.en: 'New Password', AppLocale.vi: 'Mật khẩu mới'},
